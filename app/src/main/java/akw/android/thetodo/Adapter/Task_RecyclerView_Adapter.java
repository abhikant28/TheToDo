...
public class Task_RecyclerView_Adapter extends ListAdapter<Tasks, Task_RecyclerView_Adapter.MyViewHolder> {
    ...
    public Task_RecyclerView_Adapter() {
    ...
    public void setNextAlert(Tasks task, Context cxt) {
        ...
        WorkManager.getInstance(cxt).cancelWorkById(UUID.fromString(task.getWorkerID()));
    ...
    public void showPopup(View v, int pos) {
        ...
        popupMenu.setOnMenuItemClickListener(menuItem -> {
            if (menuItem.getItemId() == R.id.Task_MenuOption_Delete) {
    ...
    private void deleteDialogBox(Tasks task, Context cxt) {
        ...
        deleteDialog.show(((FragmentActivity) cxt).getSupportFragmentManager(), "Delete Task");
    }
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View view) {
            ...
            tv_title.setOnClickListener(view13 -> {
            ...
            view.setOnLongClickListener(view1 -> {
                showPopup(view1, getAdapterPosition());
                return true;
            });
